	...
	//		cout << "............ iter = "<< iter << "..............." <<endl;
			...
			if( c_sum_restricted == 0 ){
				...
				if( c_sum_restricted > 1 ){
					...
					c_new[componentsIndex[0]] = 0;
					c_new[componentsIndex[1]] = 1;
					cConditionalDist[1] = log_f_c_new() + log(1.0-gPrior) + log(gPrior);
					// upologizw to cConditionalDist gia to (1,0) (thesi 2)
					c_new[componentsIndex[0]] = 1;
					c_new[componentsIndex[1]] = 0;
					cConditionalDist[2] = log_f_c_new() + log(1.0-gPrior) + log(gPrior);
					// upologizw to cConditionalDist gia to (0,0) (thesi 3)
					c_new[componentsIndex[0]] = 0;
					c_new[componentsIndex[1]] = 0;
					cConditionalDist[3] = log_f_c_new() + 2.0*log(1.0-gPrior);
					uni = unifRand();
